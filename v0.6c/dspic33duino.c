...
void dac1Init(char len, char ren) {
	...
	DAC1RDAT = DAC1LDAT = DAC1DFLT;			//default output at the middle
	DAC1STATbits.LOEN = len?1:0;			//1->enable output, 0->disable output
	DAC1STATbits.ROEN = ren?1:0;			//1->enable output, 0->disable output
