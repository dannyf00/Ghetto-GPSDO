...
#define PPB_LOCK	50					//ppb error to determine if pps is locked: lock deemed if frequency error falls within the PPB_LOCK
...
#define cPPS_OVN	10					//oversample. gate time. practically unlimited
#define cPID_Ix		1					//PID gain for I_term, normalized by PID_x: normalized to 1
#define cPID_Px		128					//pid gain for P_term, normalized by PID_x: 64 .. 512 (for my system, the sensitivity is about 0.6hz -> 1 dc#)
...
#define fPPS_OVN	100					//oversample. gate time. practically unlimited
